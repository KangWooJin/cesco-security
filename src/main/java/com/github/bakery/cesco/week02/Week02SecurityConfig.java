...
public class Week02SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final WAuthenticationProvider wAuthenticationProvider = new WAuthenticationProvider();
    /*
    ...
    AccessDeniedHandler accessDeniedHandler() {
        return new WAccessDeniedHandler();
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.antMatcher("/week02/**")
            ...
            .authenticationProvider(wAuthenticationProvider)
...
//            .exceptionHandling().accessDeniedHandler(accessDeniedHandler()).and()
            ...
            .anyRequest()
            .authenticated()
            .expressionHandler(expressionHandler()).and()
            .formLogin().loginProcessingUrl("/week02/find").and()
            .exceptionHandling().accessDeniedHandler(accessDeniedHandler()).and()
            .csrf().disable();
    }
}
